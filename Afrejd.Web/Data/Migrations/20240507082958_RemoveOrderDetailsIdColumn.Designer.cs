...
namespace Afrejd.Web.Migrations
{
    ...
    [Migration("20240507082958_RemoveOrderDetailsIdColumn")]
    partial class RemoveOrderDetailsIdColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Afrejd.Web.Data.Models.Product", b =>
                {
                    b.HasOne("Afrejd.Web.Data.Models.ProductCategory", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Afrejd.Web.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
